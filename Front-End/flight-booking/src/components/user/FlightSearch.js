        ...
        <div className="row mt-5 pt-5">
          <div className="col-lg-4 mb-5 grid-margin">
            <div className="card h-100">
              ...
              <div className="card-body" id="search-form">
                <form >
                  <br></br>
                  <div className="form-group" id="DepartureAirport">
                  ...
                  <br></br>
                  <div className="form-group" id="DestinationAirport">
                  ...
                  <div className="text-center">
                    <Button className="btn btn-info" onClick={searchFlights} id="SearchButtonForFlight">
                      Search
                    </Button>
                  </div>
                  <br></br>
