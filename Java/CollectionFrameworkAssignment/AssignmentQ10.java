// Q10. Create class Movie_Details with field’s mov_Name, lead_actor, lead_actories, and genre add setter and getter 
// method in that class.
// a. After creating this class create class Movie_DetailsList class who will maintain all the objects.
// b. Movie_DetailsList class should have method add_movie(), remove_movie(), remove_AllMovies(), find_movie_By_mov_Name(), 
// nd_movie_By_Genre()
