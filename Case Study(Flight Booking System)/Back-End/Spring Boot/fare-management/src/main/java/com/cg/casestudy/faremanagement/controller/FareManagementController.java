...
public class FareManagementController {
	...
	/*** Receiving GET request and returning 'All Fare List' from FlightFareService */
	...
	/*** Receiving GET request and returning 'Fare object/ Optional' from FlightFareService */
	...
	/*** Receiving POST request and returning 'String/Void' from FlightFareService */
	@PostMapping("/addFare")
	...
	/*** Receiving PUT request and returning 'String/Void' from FlightFareService */
	...
	/*** Receiving DELETE request and returning 'String/Void' from FlightFareService */
