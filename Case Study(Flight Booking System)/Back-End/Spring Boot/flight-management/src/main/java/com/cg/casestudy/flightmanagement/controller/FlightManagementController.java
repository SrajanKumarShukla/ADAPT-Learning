...
public class FlightManagementController {
    ...
    /*** Receiving request for authentication and returning JWT Token */
	...
	/*** Receiving POST request and returning 'flights list' from FlightSearchService */
	...
	/*** Receiving GET request and returning 'all flights list' from FlightSearchService */
	@GetMapping(value = "/allFlights")
	public ResponseEntity<List<Flight>> getAllFlights() {
		return ResponseEntity.ok(flightManagementService.getAllFlights());
	}

	/*** Receiving GET request and returning 'one flight' from FlightSearchService */
	...
	/*** Receiving POST request and returning response from FlightSearchService */
	...
	/*** Receiving PUT request and returning response from FlightSearchService */
	...
	/*** Receiving DELETE request and returning response from FlightSearchService*/
